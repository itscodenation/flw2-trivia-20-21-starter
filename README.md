...
## Goal 1: React Components and props

### Goal 1.1: Render a question from sample_data.json on the screen.
...
>![Goal 1.1 goal](https://i.imgur.com/eTZAXGk.png)

### Goal 1.2: Render a "Next Question" button on the screen.
...
>![Goal 1.2 goal](https://i.imgur.com/o4MzPjL.png)


## Goal 2: Nested components and state

### Goal 2.1: Render the answer choices from sample_data.json on the screen.
...
>![Goal 2.1 goal](https://i.imgur.com/VpA8eRc.png)

### Goal 2.2: Render a button on the screen that reveals the correct answer when clicked.
...
>![Goal 2.2 goal - unanswered](https://i.imgur.com/JI6GroE.png)
>![Goal 2.2 goal - answered](https://i.imgur.com/rufYX84.png)


## Goal 3: Event handlers

### Goal 3.1: Add functionality to your "Next Question" button so that it renders the next question when clicked.

- [ ] Add state to `<App />` using the `useState` React hook to keep track of the current question number.
  - [ ] Replace the current question number variable that you wrote in Goal 1.
...
>![Goal 3.1 goal](https://i.imgur.com/fetraPF.png)
>![Goal 3.1 with bonus](https://i.imgur.com/GruM8g2.png)

### Goal 3.2: Add functionality so that when the user clicks on an answer choice, the correct answer appears.
...
### Goal 3.3: Sort your Trivia app into separate files and import/export the components.
...
>![Goal 3.3 correct](https://i.imgur.com/HC7M6LH.png)
>![Goal 3.3 wrong](https://i.imgur.com/DWQu3bb.png)
